...
public class HeadersValidationTest extends BaseTest {
    ...
    public void nameAndValueHeaderSuccessTest() {
        ...
        PostResponseValidationProcessor validation = header("name1", "1");
    ...
    public void nameAndValueHeaderFailTest() {
        ...
        PostResponseValidationProcessor validation = header("name2", "1");
    ...
    public void headerSuccessTest() {
        ...
        PostResponseValidationProcessor validation = header(new Header("name1", "1"));
        expectValidationSuccess(validation, response);
    }
    ...
    public void headerFailTest() {
        ...
        PostResponseValidationProcessor validation = header(new Header("name2", "1"));
        expectValidationFailWithErrorText(validation, response, "Expected: list containing item [\"name2\", \"1\"]");
    }
    ...
    public void nameAndValueMatcherHeaderSuccessTest() {
        ...
        PostResponseValidationProcessor validation = header("name1", containsString("1"));
        expectValidationSuccess(validation, response);
    }
    ...
    public void nameAndValueMatcherHeaderFailTest() {
        ...
        PostResponseValidationProcessor validation = header("name1", containsString("2"));
    ...
    public void nameAndParsingFunctionAndValueMatcherHeaderSuccessTest() {
        ...
        PostResponseValidationProcessor validation = header("name1", Integer::parseInt, lessThan(2));
        expectValidationSuccess(validation, response);
    }
    ...
    public void nameAndParsingFunctionAndValueMatcherHeaderFailTest() {
        ...
        PostResponseValidationProcessor validation = header("name1", Integer::parseInt, lessThan(1));
    ...
    public void headersSuccessTest() {
        ...
        PostResponseValidationProcessor validation = headers(containsPair("name1", "value1"));
        expectValidationSuccess(validation, response);
    }
    ...
    public void headersFailTest() {
        ...
        PostResponseValidationProcessor validation = headers(containsPair("name1", "wrong value"));
